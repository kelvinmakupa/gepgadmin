...
$applications = mysqli_query($obj->con, "select * from kelvin where check_no='HD/UDOM/0515/T.2020'");      
...
$i++;
    try{         
			   ...
			   // $bill_amount=$row['bill_amount'];
				$payment_type_id=161; //to change income_code  142=ada, 159=quality 
            ...
            $bill_description='Contribution to UDOSO';       
