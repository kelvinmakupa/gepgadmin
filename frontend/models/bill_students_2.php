...
$applications = mysqli_query($obj->con, "select * from student_details where id>31883 order by programme_code ASC");

//$applications = mysqli_query($obj->con, "select * from allen_round_four");
   

//$applications = mysqli_query($obj->con, "select * from nguma_imtu");
...
// FROM sila_continue
// WHERE reg_no<>'T/UDOM/2015/05791' AND programme_code IN('DM001','DM002','16DP101','16DP102','16DP103')
...
$i++;      
    try{           
       // $fee_array=array(['local_amount'=>'20000','acc_code'=>'41190000','description'=>'Quality Assurance','payment_type_id'=>'39'],['local_amount'=>'228500','acc_code'=>'12010','description'=>'Direct Cost','payment_type_id'=>'37'],['local_amount'=>'50400','acc_code'=>'41191000','description'=>'NHIF Health Insurance','payment_type_id'=>'38']);
       // $fee_array=array(['local_amount'=>'10000','acc_code'=>'12010','description'=>'Direct Cost','payment_type_id'=>'37']);

    $fee_array=array(['local_amount'=> '50400','acc_code'=>'41191000','description'=>'NHIF Health Insurance','payment_type_id'=>'38'],['local_amount'=>'20000','acc_code'=>'41190000','description'=>'Quality Assurance','payment_type_id'=>'39']);
   //  $fee_array=array(['local_amount'=>'20000','acc_code'=>'41190000','description'=>'Quality Assurance','payment_type_id'=>'39']);
//    $fee_array=array(['local_amount'=>'260000','acc_code'=>'12010','description'=>'Direct Cost','payment_type_id'=>'37']);
      foreach( $fee_array as $fee){                      
            //$gepg_flag=false;                 
                         
           // if(($fee['payment_type_id']==1)||($fee['payment_type_id']==37)){                   

                    $gepg_flag=true;     
                    $currency='TZS';    
                    $bill_amount=$fee['local_amount'];
                    // $bill_amount=$row['direct_cost'];
