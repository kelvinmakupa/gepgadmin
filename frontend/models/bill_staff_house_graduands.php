...
/*$applications = mysqli_query($obj->con, "SELECT check_no,name FROM graduands_bill_batch 
WHERE check_no not in(select check_no from graduands_bill)");        
 */
 
 //masters
$applications = mysqli_query($obj->con, "select * from masters_temp");             
...
$i++;    
    try{         
			   ...
			   // $bill_amount=$row['bill_amount'];
				$payment_type_id=128; //to change income_code  142=ada, 159=quality 
            ...
            $bill_description='Graduation Fees';       
