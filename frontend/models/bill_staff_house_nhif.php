...
$applications = mysqli_query($obj->con, "select * from kelvin");            
    ...
    try{         
			  ...
			  // $bill_amount=1200000;      
			   // $bill_amount=$row['bill_amount'];
				$payment_type_id=113; //to change income_code  142=ada post, 159=quality  //144 ada non degree //141 ada undergraduate
                $bill_pay_opt='2';    //3=full,2:partial   
                $control_number='';  
