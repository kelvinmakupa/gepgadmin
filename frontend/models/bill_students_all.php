...
$obj=new OAS();
 ...
 //$applications = mysqli_query($obj->con, "select * from student_details where citizenship='Tanzanian' AND reg_number in('T/UDOM/2018/15859')");
$applications = mysqli_query($obj->con, "select * from student_details where is_delete=1  and citizenship='Tanzanian' and id>17443");
//$applications = mysqli_query($obj->con, "select * from student_details where is_delete=1  and citizenship='Tanzanian' order by id desc limit 20");
