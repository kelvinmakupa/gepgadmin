...
<div class="col-md-4 col-sm-6 col-xs-12">
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Today's Collection - TZS</span>
                <span class="info-box-number"><?=Common::getTodayCollection('TZS') ?></span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number"><?=Common::applicationFee()?></span>
            </div>
 ...
 <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Today's Collection - USD</span>
                <span class="info-box-number"><?=Common::getTodayCollection('USD') ?></span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
...
<!-- /.col -->
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Today's Number of Bills</span>
                <span class="info-box-number"><?=Common::getTodayNumberOfBills() ?></span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
...
<div class="col-md-8">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Transactions Graph - TZS</h3>
    ...
    <div class="col-md-4">
        <p class="text-center">
            <strong>Today's Collection - TZS</strong>
        </p>

        <?php

        echo Common::getTodayBankCollection(2,'green');

        echo Common::getTodayBankCollection(3,'yellow');

        echo Common::getTodayBankCollection(4,'purple');
