...
class TblBillingSearch extends TblBilling
{
    ...
    {
        return [
            [['id','payer', 'payment_type_id', 'company_id', 'bill_pay_opt', 'is_posted', 'is_cancelled'], 'integer'],
            [['payer_name', 'bill_exp_date', 'bill_description', 'bill_gen_by', 'bill_appr_by', 'payer_cell_num', 'payer_email', 'bill_currency', 'bill_gen_date', 'bill_id', 'control_number', 'use_on_pay', 'bill_item_ref'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            //'bill_gen_date' => $this->bill_gen_date,
