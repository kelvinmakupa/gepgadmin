...
class TblBilling extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['payer_name','payer', 'bill_amount', 'bill_exp_date', 'bill_description', 'bill_gen_by', 'bill_appr_by', 'bill_currency', 'payment_type_id', 'company_id', 'bill_id', 'control_number', 'bill_pay_opt', 'use_on_pay', 'bill_eqv_amount', 'bill_item_ref', 'is_posted'], 'required'],
    ...
    public function scenarios(){
        ...
        $scenarios['student']=['payer_name','payer','payer_cell_num', 'payer_email','payment_type_id','bill_currency','bill_amount','bill_eqv_amount',
            'bill_exp_date','bill_description','bill_gen_date','bill_pay_opt','use_on_pay',
